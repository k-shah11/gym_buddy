...
import poohHappy from "@assets/Gemini_Generated_Image_back3oback3oback_1764257249750.png";
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12 md:py-20">
        <div className="text-center space-y-4 sm:space-y-6 mb-8 sm:mb-12">
          <div className="flex justify-center">
            <img src={poohHappy} alt="Gym Buddy Pooh" className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40" />
          </div>
